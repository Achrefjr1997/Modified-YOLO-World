...
class C3k2(C2f):
    ...
    def __init__(self, c1, c2, n=1, c3k=False, e=0.5, g=1, shortcut=True):
        ...
        self.m = nn.ModuleList(
            C3k(self.c, self.c, 3, shortcut, g) if c3k else Bottleneck(self.c, self.c, shortcut, g) for _ in range(n)
        )
...
#class C3k(C3):
    ...
    #   c_ = int(c2 * e)  # hidden channels
        ...
        #####################
    #    self.m = nn.ModuleList(Bottleneck_CA1(c_, c_, shortcut, g, k=(3, 3), e=1.0) for _ in range(n))
class C3k(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=True, g=1, e=0.5):
        ...
        self.m = nn.Sequential(*(Bottleneck_CA1(c_, c_, shortcut, g, k=(3, 3), e=1.0) for _ in range(n)))
